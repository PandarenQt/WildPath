...
export function reactionChoiceValueFromForm(viewModel, response) {
    ...
    if (typeof response === "object" && response !== null) {
        if ("get" in response && typeof response.get === "function")
            selected = response.get(name);
        else if (Object.hasOwn(response, name))
            selected = Reflect.get(response, name);
    }
