import type {TokenGridFootprint} from "../types/contracts.js";
...
export interface MovementObserver {
  ...
  readonly reachFields: number;
  readonly context?: Readonly<Record<string, unknown>>;
}

/** Observer-relative facts only. Predicates own hostility, movement kind and reaction eligibility. */
export function movementTransitionRelations(previous: TokenGridFootprint, proposed: TokenGridFootprint,
  observers: readonly MovementObserver[]) {
