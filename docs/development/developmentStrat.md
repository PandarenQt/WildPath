...
through the `wildpath.staged-movement` Quench batch, and its paired GM/player [sentinel](staged-movement-qa.md)
(ordinary, decline, Large-hex decline) passed with committed canonical exports on 2026-09-20.
